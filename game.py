...
from constants import WHITE, BLACK, BLUE, ORANGE, SQUARE_SIZE
...
class Game:
    ...
    def update(self):
        ...
        self.draw_attacking_moves(self.valid_moves)
    ...
    def _move(self, row, col):
        ...
        if self.selected and (row, col) in self.valid_moves:
            contact = self.valid_moves[(row, col)]
    ...
    def draw_attacking_moves(self, moves):
        for move in moves:
            row, col = move
